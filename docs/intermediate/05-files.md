...
The beginning labs run right in your browser using inline Skulpt Python editors.  Some of the labs in the intermediate class, however, need access to your local file system to learn how to open and manipulate files.  To do this you must install Python on your local computer.
...
At this point you should now have Python installed on your computer for these file-based labs. We recommend [installing Anaconda](https://www.anaconda.com/products/individual) and using the Spyder integrated development environment (IDE). 
